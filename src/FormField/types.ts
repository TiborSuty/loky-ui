...
import {MentionsInputProps} from '../MentionsInput/types/MentionsInputProps';
...
import {SuggestionInputProps} from '../SuggestionInput/types/SuggestionInputProps';
...
export type ControlProps<TFieldValues extends FieldValues, FieldType extends FormFieldType> = {
  ...
  creatableMultiChoice: PropsWithTypedName<
    ...
    FieldType
  >;
  mentionsInput: PropsWithTypedName<MentionsInputProps<OptionType>, TFieldValues, FieldType>;
  suggestionInput: PropsWithTypedName<SuggestionInputProps, TFieldValues, FieldType>;
}[FieldType];
